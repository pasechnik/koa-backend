...
import { User, userSchema } from '../model/entity/user';
...
export default class UserController {
  ...
  public static async createUser(ctx: Context): Promise<void> {
    ...
    userToBeSaved.familyName = ctx.request.body.familyName;
    userToBeSaved.givenName = ctx.request.body.givenName;
  ...
  public static async updateUser(ctx: Context): Promise<void> {
    ...
    userToBeUpdated.familyName = ctx.request.body.familyName;
    userToBeUpdated.givenName = ctx.request.body.givenName;
